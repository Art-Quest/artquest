  ...
  return (
    <div className={css.home}>
      <div className={css.bg}>
        <div
          className={css.lines1}
          style={{ backgroundImage: `url(${lines1})` }}
        />
        <div
          className={css.lines2}
          style={{ backgroundImage: `url(${lines2})` }}
        />
        <div
          className={css.lines3}
      ...
      >
        <div className={css.drawerContent}>
          <Grid container spacing={3}>
            ...
            <Grid item xs={12}>
              <h2>
                It&apos;s <b>lunchtime</b>, adventurer!
              </h2>
            </Grid>

            {explainerContent.map((item, idx) => (
              <Grid container spacing={0} key={idx}>
                <Grid item xs={12} sm={9}>
                  <div className={css.inner}>
                    <h3>{item.title}</h3>
                    <div
                      className={css.explainerContent}
            ...
            <Grid item xs={12}>
              <p>
                <b>Movement:</b> Use the <b>buttons</b> at the bottom of the
                screen to move. The center button with the X on it is an action
                button. Use it to take an item or go up or down on a ladder.
                There are characters to talk to. Walk onto their square to start
                a conversation. You can also use <b>QWAS keys</b> to move
                around, and the <b>spacebar</b> is the action button.
              </p>
            </Grid>
            ...
            >
              <button className={css.menuButton} onClick={toggleDrawer}>
                <IconExit className={css.btnIcon} /> Done
              </button>
            </Grid>
          </Grid>
        </div>
