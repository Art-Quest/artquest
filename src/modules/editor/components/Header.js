...
import {
  ArrowForward as IconUp,
  ArrowBack as IconDown,
    ...
    <AppBar className={css.header}>
      <Toolbar className={css.headerToolbar}>
        <div className={css.floorNum}>
          ...
          <div>
            <span className={css.numLabel}>Floor</span>
            <span className={css.numDisp}>{currentFloor}</span>
          </div>
        ...
        <Button variant="contained" onClick={handleCopyDataAreas}>
          Copy Areas
        </Button>

        <Button variant="contained" onClick={handleCopyDataItems}>
          Copy Items
        </Button>
      </Toolbar>
    </AppBar>
