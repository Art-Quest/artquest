...
import { cn } from "./Components/lib/utils";
 ...
 function AuroraBackgroundDemo() {
  return (
    ...
    <div className="flex flex-col md:flex-row items-start md:items-center justify-start md:justify-center mx-auto px-6 md:px-16">
  <div className="md:w-[60%]">
    <div className="text-4xl md:text-6xl font-bold dark:text-white leading-tight">
